...
//     const bool &threadActiveFlagRef = _threadsActiveFlag;
...
//                                                 std::chrono::system_clock::now(), [sendPacketsQueueRef,threadActiveFlagRef]()
//                                                 { return !sendPacketsQueueRef.empty() || !threadActiveFlagRef; });
